...
static void SampleUi_MainCB(void)
{
    ...
    // If a palette fade is active, tick the update
    UpdatePaletteFade();
}
...
static void SampleUi_DrawMonIcon(u16 dexNum)
{
     ...
     */
    sSampleUiState->monIconSpriteId = CreateMonIcon(speciesId, SpriteCB_MonIcon, MON_ICON_X, MON_ICON_Y, 0, 4, 0);
